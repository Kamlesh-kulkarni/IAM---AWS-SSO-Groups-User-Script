...
$excelPath = ".\AWS_XL_SSO_Role_Assignments-2.xlsx"
$result | Export-Excel -Path $excelPath -AutoSize -BoldTopRow -Title "AWS XL - SSO Role Assignments" -WorksheetName "Assignments"
